...
run_button = ttk.Button(text="Run Score",command=run_score)
stop_button = ttk.Button(text="Halt Score",command=halt_score)
run_button.grid(row=3,column=2)
stop_button.grid(row=3,column=0,sticky='w')
